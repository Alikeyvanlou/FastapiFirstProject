...
from dependencies.dependencies import verify_refresh_token
...
def user_login_route(response: Response, db: Session = Depends(get_db), item: OAuth2PasswordRequestForm = Depends()):
